...
newsletterStyle.textContent=`#offerte,nav a[href="#offerte"]{display:none!important}#newsletter-form{display:flex;flex-wrap:wrap;gap:10px;max-width:520px;margin-top:22px}#newsletter-form input{flex:1;min-width:210px;border:1px solid #cdd9d2;background:#fff;color:#153b35;padding:15px 16px;font:16px Arial}#newsletter-form button{border:0;background:#c98b68;color:#fff;padding:15px 22px;font:700 15px Arial;cursor:pointer;white-space:nowrap}#newsletter-form button:hover{background:#e6a882}#newsletter-message{flex-basis:100%;color:#d9eee0;font:14px Arial}footer.footer a{color:inherit;text-decoration:none;border-bottom:1px solid currentColor;padding-bottom:2px}footer.footer a:hover{opacity:.72}`;
